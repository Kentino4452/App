...
// MARK: - Model placeholder (rimpiazza con il tuo DTO quando colleghi l’API)
struct Property {
    let title: String
    let address: String
    let price: String
...
final class HomeViewController: UIViewController,
    ...
    // Dati mock per ora: sostituisci con i risultati di GET /api/properties/
    private var properties: [Property] = [
        .init(title: "Modern apartment", address: "Central",   price: "$1.200.000", rooms: "2 rooms", image: UIImage(named: "sample1")),
        .init(title: "Single-family home", address: "Suburbia", price: "$875.000",   rooms: "4 rooms", image: UIImage(named: "sample2")),
        .init(title: "Spacious condo",     address: "Downtown", price: "$950.000",   rooms: "3 rooms", image: UIImage(named: "sample3")),
        .init(title: "Ranch-style house",  address: "Suburbia", price: "$780.000",   rooms: "3 rooms", image: UIImage(named: "sample4"))
    ]
    ...
    private func configureDistanceMenu() {
        let actions: [UIAction] = ["+ 0 km", "+ 1 km", "+ 5 km", "+ 10 km"].map { title in
            UIAction(title: title) { [weak self] _ in
                ...
                // TODO: applica filtro distanza ai dati
            }
        }
    ...
    @objc private func priceChanged() {
        // Esempio: aggiorna label max dinamicamente (opzionale)
        ...
        // TODO: filtra datasource e ricarica
    }

    @objc private func roomsChanged() {
        let raw = Int(round(roomsSlider.value))
        roomsSlider.value = Float(raw) // snap all’intero
    ...
    @objc private func openMenu() {
        ...
        alert.addAction(UIAlertAction(title: "Logout", style: .destructive, handler: { _ in
            // TODO: esegui logout se/quando implementato
        }))
    ...
    func collectionView(_ collectionView: UICollectionView,
        ...
        let insets: CGFloat = 8 * 2 // left + right (da constraints)
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        // TODO: spingi PropertyDetailViewController con l’ID reale della proprietà
        let detail = PropertyDetailViewController()
...
final class PropertyCell: UICollectionViewCell {
    ...
    func configure(with property: Property) {
        imageView.image = property.image ?? UIImage(systemName: "house.fill")
